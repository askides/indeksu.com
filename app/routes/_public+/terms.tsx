export default function Page() {
  return (
    <main className="px-5 max-w-5xl mx-auto py-24">
      <section>
      ...
      <article className="prose prose-lg my-24 mx-auto">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Indeksu.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Indeksu, accessible from{" "}
              <a
                href="https://indeksu.com"
        ...
        <ul>
          <li>By email: askides@proton.me</li>
        </ul>
      </article>

      <div className="h-20 w-[2px] bg-emerald-100 mx-auto" />
    </main>
  );
}
