...
INSERT INTO "new_oauth_tokens" ("access_token", "created_at", "id", "scopes", "updated_at", "user_id") SELECT "access_token", "created_at", "id", "scopes", "updated_at", "user_id" FROM "oauth_tokens";
